...
class OldEmployees extends React.Component {
  ...
  getEmployeeList=async(division)=>{
    ...
    var url = SERVER_URL + '/api/HR/exitManagement/?is_exited=true'
                ...
                <View style={{flexDirection: 'row',height:55,alignItems: 'center',backgroundColor:'#f3f3f3'}}>
                 ...
                 justifyContent:'center'}}>
                   ...
                   <View style={{width:width*0.85,alignItems:'center',justifyContent:'center'}}>
                    <Text style={{color:'#252525',fontSize:20,fontWeight:'700',textAlign:'center',marginLeft:-(width*0.15)}}>Old Employees</Text>
                   </View>
                </View>
              </View>
